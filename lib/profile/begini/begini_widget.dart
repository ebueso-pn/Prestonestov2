...
import 'begini_model.dart';
export 'begini_model.dart';

class BeginiWidget extends StatefulWidget {
  const BeginiWidget({Key? key}) : super(key: key);

  @override
  _BeginiWidgetState createState() => _BeginiWidgetState();
}

class _BeginiWidgetState extends State<BeginiWidget> {
  late BeginiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BeginiModel());
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if ((_model.apiResultwum?.succeeded ?? true)) {
                            await launchURL(
                                'https://app.psychometric.me/${BeginiTokenCall.accessToken(
                              (_model.apiResultwum?.jsonBody ?? ''),
                            ).toString()}');
                          } else {
