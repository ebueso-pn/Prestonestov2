...
class _ApplicationMapWidgetState extends State<MapPage> {
  ...
  Future<void> _handleFixAddressPressed() async {
    ...
    // Use the current map center as the coordinates to update
    final LatLng? center = _model.googleMapsCenter ?? currentUserLocationValue;
    if (center == null) {
      setState(() => _loading = false);
      showSnackbar(context, 'No se pudo obtener la ubicación.');
      return;
    }

    final result = await UserService.updateCoordinates(center.latitude, center.longitude);

    setState(() => _loading = false);

    if (result['success'] == true) {
      context.pushNamed('Carrousel');
    } else {
      final errorMsg = result['error'] == 'network'
                            ...
                            children: [
                              Builder(builder: (context) {
                                ...
                                final LatLng defaultLatLng =
                                    LatLng(14.0722758, -87.192136);
                                final LatLng markerLatLng =
                                    currentUserLocationValue ?? defaultLatLng;
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          isEnable: !_loading,
                          onPressed: _handleFixAddressPressed,
